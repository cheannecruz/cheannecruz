<template>
  ...
  >
    <div class="main-banner__content">
      ...
      <div class="main-banner__img" data-aos="fade" data-aos-delay="2000">
...
.main-banner__img-arm-left {
  position: absolute;
  z-index: 6;
  width: 9%;
  left: 34%;
  top: 40%;
  animation: left-arm 2s 1s ease infinite;
}

.main-banner__img-arm-right {
  position: absolute;
  z-index: 6;
  width: 9%;
  left: 51%;
  top: 40%;
  animation: right-arm 2s 1s ease infinite;
}

.main-banner__img-head {
  position: absolute;
  z-index: 7;
  left: 37%;
  top: 20%;
...
.floating-lg {
  animation: floating-lg 5s ease infinite;
}
